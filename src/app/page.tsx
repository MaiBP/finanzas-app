  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#ff9655] text-[#3a3434]">
      ...
      <nav className="relative z-10 mx-auto flex max-w-6xl items-center justify-between border-b border-[#3a3434]/40 px-5 py-6 uppercase">
        <div className="flex items-center gap-2 text-lg font-black"><span className="grid size-10 place-items-center rounded-full bg-[#ffff50] text-xl">½</span>Miti-Miti</div>
      ...
      <section className="relative z-[1] mx-auto grid max-w-6xl items-center gap-12 px-5 py-16 md:grid-cols-2 md:py-24">
        <div>
          ...
          <p className="mt-6 max-w-lg text-lg leading-8">Miti-Miti organiza gastos, separa lo personal de lo compartido y os ayuda a entender el mes de un vistazo. Sin hojas imposibles.</p>
